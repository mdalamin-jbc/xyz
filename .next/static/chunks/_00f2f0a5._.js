...
"[project]/src/app/(admin)/admin/(routes)/photo-edit-requests/[uid]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const PhotoEditRequestDetailPage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PhotoEditRequestDetailPage.useEffect": ()=>{
            const fetchData = {
                "PhotoEditRequestDetailPage.useEffect.fetchData": async ()=>{
                    setLoading(true);
                    setError(null);
                    try {
                        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$baseApi$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["baseUrl"]}/gallery/admin/photo-edit-requests/${uid}`, {
                            method: "GET",
            ...
            }["PhotoEditRequestDetailPage.useEffect.fetchData"];
            if (uid) fetchData();
    ...
    const handleStatusChange = async (e)=>{
        ...
        try {
            ...
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$baseApi$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["baseUrl"]}/gallery/admin/photo-edit-requests/${uid}/update-status`, {
                method: "PATCH",
                headers,
                body: JSON.stringify({
...
_s(PhotoEditRequestDetailPage, "ygPWrZR3rWDlLKJ9nGIn/K7L+hA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"]
    ];
});
_c = PhotoEditRequestDetailPage;
const __TURBOPACK__default__export__ = PhotoEditRequestDetailPage;
var _c;
__turbopack_context__.k.register(_c, "PhotoEditRequestDetailPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_00f2f0a5._.js.map