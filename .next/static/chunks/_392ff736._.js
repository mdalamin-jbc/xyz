...
"[project]/src/app/(admin)/admin/(routes)/souvenir-requests/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const MainComponent = ()=>{
    ...
    const fetchRequests = async ()=>{
        try {
            ...
            setTotalCount(data.count || data.total || (Array.isArray(data) ? data.length : 0));
            setTotalPages(data.totalPages || Math.ceil((data.count || data.total || 0) / 10));
        } catch (error) {
    ...
    const handleStatusChange = async (requestId, newStatus)=>{
        try {
            const accessToken = ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem("accessToken") : ("TURBOPACK unreachable", undefined);
            const response = await fetch(`https://15.206.185.80/gallery/admin/souvenir-requests/${requestId}/update`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                    ...accessToken ? {
            ...
            setRequests((prevRequests)=>prevRequests.map((request)=>request.uid === requestId ? {
                        ...request,
                        status: newStatus
                    } : request));
        } catch (err) {
    ...
    const getStatusBadge = (status)=>{
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            fileName: "[project]/src/app/(admin)/admin/(routes)/souvenir-requests/page.tsx",
            lineNumber: 143,
            columnNumber: 7
        }, this);
    };
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    ...
                    error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mb-4 rounded bg-red-50 p-3 text-sm text-red-500 flex items-center justify-between",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: error
                            }, void 0, false, {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    ...
                                    children: [
                                        requests.map((request)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-4 py-4 text-sm text-gray-600 font-mono",
                                                        children: [
                                                            "#",
                                                            request.uid
                                                        ]
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        ...
                                                        children: request.souvenir_type
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/(admin)/admin/(routes)/souvenir-requests/page.tsx",
                                                        lineNumber: 295,
                                                        columnNumber: 21
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-4 py-4 text-sm text-gray-600",
                                                        children: request.budget ? `¥${request.budget.toLocaleString()}` : "-"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/(admin)/admin/(routes)/souvenir-requests/page.tsx",
                                                        lineNumber: 303,
                                                        columnNumber: 21
                                        ...
                                        requests.length === 0 && !loading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("i", {
                                                            className: "fa-regular fa-file-lines text-2xl text-gray-400"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/(admin)/admin/(routes)/souvenir-requests/page.tsx",
                                                            lineNumber: 346,
                                                            columnNumber: 25
                                                        ...
                                                        (searchTerm || selectedStatus !== "all") && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                            onClick: clearFilters,
...
_s(MainComponent, "QXuIFXE+uU1ttP91APeIk5KCxjY=");
_c = MainComponent;
...
//# sourceMappingURL=_392ff736._.js.map