...
const VideoEditRequestDetailPage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VideoEditRequestDetailPage.useEffect": ()=>{
            const mockData = {
                uid: "VID-2024-007",
                description: "企業紹介動画の編集をお願いします。オープニングとエンディングのタイトル追加、BGM挿入、カラーグレーディングを行ってください。全体的にプロフェッショナルな仕上がりを希望します。",
                special_note: "クライアントプレゼン用なので、高品質な仕上がりをお願いします。音声レベルの調整も重要です。",
            ...
            }["VideoEditRequestDetailPage.useEffect"], 1000);
        }
    }["VideoEditRequestDetailPage.useEffect"], []);
...
_s(VideoEditRequestDetailPage, "WZzaPiJcl+El8mN7kC6UAdeBHbQ=");
...
//# sourceMappingURL=_356dfe34._.js.map