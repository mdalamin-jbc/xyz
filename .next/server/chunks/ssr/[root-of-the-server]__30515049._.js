...
"[project]/src/app/(user)/login/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const loginSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$dist$2f$esm$2f$v3$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$dist$2f$esm$2f$v3$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, "メールアドレスを入力してください").email("有効なメールアドレスを入力してください"),
    password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$dist$2f$esm$2f$v3$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, "パスワードを入力してください").min(6, "パスワードは6文字以上で入力してください")
});
const LoginPage = ()=>{
    ...
    const checkSubscriptionStatus = async ()=>{
        ...
        if (role === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$role$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["user_role"].SUPER_ADMIN) {
            return "/admin";
        }
        try {
            const subscriptionStatus = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$subscription$2f$subscriptionAPIClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["subscriptionApiClient"].getSubscriptionStatus();
    ...
    const onSubmit = async (data)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$infrastructure$2f$user$2f$userAPIClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["userApiClient"].userLogin(data);
            if (response.access && response.refresh) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].set("accessToken", response.access, {
                    expires: 7,
                    secure: ("TURBOPACK compile-time value", "development") === "production"
                });
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].set("refreshToken", response.refresh, {
                    expires: 30,
                    secure: ("TURBOPACK compile-time value", "development") === "production"
                });
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].set("role", response.user.kind, {
                    expires: 7,
                    path: "/"
                });
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("ログイン成功!", {
                position: "top-center"
            });
            await new Promise((resolve)=>setTimeout(resolve, 800));
            if (response.user.kind === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$role$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["user_role"].SUPER_ADMIN) {
                router.push("/admin");
            } else {
            ...
            if (error.response?.status === 401) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("メールアドレスまたはパスワードが正しくありません", {
                    position: "top-center"
                });
            } else if (error.response?.status === 400) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("入力内容に誤りがあります", {
                    position: "top-center"
                });
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("ログインに失敗しました。しばらく時間をおいて再度お試しください", {
                    position: "top-center"
                });
            }
        } finally{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__30515049._.js.map